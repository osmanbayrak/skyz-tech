      ...
      <div id="tech" className="homeDiv">
        ...
        <Row className="contentBlock">
          ...
          <Col lg={24} xl={8}>
            ...
            <Card className="homeCard" bodyStyle={{height: '340px', minHeight: '340px', overflow: 'scroll'}} cover={<span style={{overflow: 'hidden', borderRadius: '25px' , borderBottomLeftRadius: '0', borderBottomRightRadius: '0'}}><img className="techCardsCover" alt="example" src={complianceImg} /></span>}>
