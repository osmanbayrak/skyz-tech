    ...
    return (
      <div id="expertise" className="homeDiv">
        ...
        <Row className="contentBlock">
          <Col lg={24} xl={12} >
          <Card className="homeCard" bodyStyle={{height: '340px', minHeight: '340px', overflow: 'scroll'}}>
            <div style={{marginTop: '30px'}}><Icon style={{fontSize: '40px'}} type="deployment-unit" /></div>
          ...
          <Col lg={24} xl={12} >
            <Card className="homeCard" bodyStyle={{height: '340px', minHeight: '340px', overflow: 'scroll'}}>
              <div style={{marginTop: '30px'}}><Icon style={{fontSize: '40px'}} type="database" /></div>
          ...
          <Col lg={24} xl={12} >
          <Card className="homeCard" bodyStyle={{height: '340px', minHeight: '340px', overflow: 'scroll'}}>
              <div style={{marginTop: '30px'}}><Icon style={{fontSize: '40px'}} type="apartment" /></div>
          ...
          <Col lg={24} xl={12} >
            <Card className="homeCard" bodyStyle={{height: '340px', minHeight: '340px', overflow: 'scroll'}}>
              <div style={{marginTop: '30px'}}><Icon style={{fontSize: '40px'}} type="rocket" /></div>
